import { MessageFlags, PermissionsBitField, SlashCommandAttachmentOption, SlashCommandBuilder, SlashCommandStringOption, SlashCommandUserOption, type MessageCreateOptions, type User } from 'discord.js';
