import { Collection, GuildMember, Message, MessagePayload, type BooleanCache, type ChatInputCommandInteraction, type Client, type Guild, type GuildTextBasedChannel, type If, type InteractionCallbackResponse, type InteractionDeferReplyOptions, type InteractionEditReplyOptions, type InteractionReplyOptions, type InteractionResponse, type MessageEditOptions, type MessagePayloadOption, type MessageReplyOptions, type MessageResolvable, type OmitPartialGroupDMChannel, type Snowflake, type TextBasedChannel, type User } from 'discord.js';
...
/**
 * Resolves the cache type based off of `InGuild`.
 */
export type GuildCacheType<InGuild extends boolean> = If<InGuild, 'cached' | 'raw', undefined>;

/**
 * Represents the context for a slash command.
 */
...
/**
 * Represents the context for a message command.
 */
