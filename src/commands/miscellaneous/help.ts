...
export default async function execute(ctx: CommandContext): Promise<void> {
...
export function registerHelpCommand({ slashCommands, messageCommands }: CommandManagers): void {
